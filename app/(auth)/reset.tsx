...
export default function Signup() {
  ...
  const signupFunction = async () => {
    try {
      if (!creadentail.password.match(expressions.password)) {
        throw new Error("Details are not valid!");
      }

      setMessage("Password Reset Succesfully, please Login");
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <View style={style.loginContainer}>
          <View style={style.aboveContainer}>
            <AuthHeading screen="reset" additionalText="" />
